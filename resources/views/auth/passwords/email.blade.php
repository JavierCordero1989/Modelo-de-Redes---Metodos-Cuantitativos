...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/css_descargado/font-awesome.min.css') }}">
...
<div class="login-box">
    <div class="login-logo">
        <a href="{{ url('/home') }}"><b>Alliance </b>Systems</a>
    </div>

    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">Ingrese su correo para reestablecer la contraseña</p>
